...
namespace Central.Tests.Unit
{
    ...
    {
        private CentralApplicationDbContext CreateDbContext()
        {
            var options = new DbContextOptionsBuilder<CentralApplicationDbContext>()
                .UseInMemoryDatabase(Guid.NewGuid().ToString())
                .Options;

            return new CentralApplicationDbContext(options);
        }
